...
class Permohonanbarang_model extends CI_Model {
    ...
    {	
    	...
    	$this->db->select("(select SUM(harga*jumlah) AS hrg FROM inv_permohonan_barang_item WHERE id_inv_permohonan_barang=inv_permohonan_barang.id_inv_permohonan_barang and inv_permohonan_barang_item.code_cl_phc=inv_permohonan_barang.code_cl_phc) AS totalharga");
   ...
   function insert_entry()
    ...
    function totalharga($kode,$puskesmas){
    	$data = array();
    	$this->db->where('code_cl_phc',$puskesmas);
    	$this->db->where('id_inv_permohonan_barang',$kode);
