	   ...
	   var source = {
		...
		{		
			...
			columns: [
				...
				{ text: 'Nama Barang', datafield: 'nama_barang', columntype: 'textbox', filtertype: 'textbox', width: '26%' },
				...
				{ text: 'Keterangan',datafield: 'keterangan', columntype: 'textbox', filtertype: 'textbox', width: '21%'}
           ]
		});
